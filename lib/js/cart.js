    ...
    function basket() {
		...
		function updatetable(){
			...
			if (itemInBasket.length==1){
				...
				$("#pricehere").html('<span><b>Total Price: </b><span id=price></span>£</span><div>Discount applied: <span id=discount></span>£</span></div>');
			...
			if(BreadCounter==1){
				...
				$("#breaddiv").html('Bread: <span id="breadquantity"></span>');
				$("#breadquantity").text(BreadCounter);
			...
			if (ButterCounter==1){
				...
				var element = document.getElementById("table");
				element.appendChild(para);
				$("#butterdiv").html('Butter: <span id="butterquantity"></span>');
				$("#butterquantity").text(ButterCounter);
			...
			if (MilkCounter==1){
				...
				var element = document.getElementById("table");
				element.appendChild(para);
				$("#milkdiv").html('Milk: <span id="milkquantity"></span>');
				$("#milkquantity").text(MilkCounter);
